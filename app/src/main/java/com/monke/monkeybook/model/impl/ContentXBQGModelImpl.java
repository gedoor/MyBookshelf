...
public class ContentXBQGModelImpl extends BaseModelImpl implements IStationBookModel {
    public static final String TAG = "http://www.xxbiquge.com";

    public static ContentXBQGModelImpl getInstance() {
        return new ContentXBQGModelImpl();
    }
