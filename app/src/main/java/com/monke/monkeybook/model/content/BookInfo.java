    ...
    public Observable<BookShelfBean> analyzeBookInfo(String s, final BookShelfBean bookShelfBean) {
        return Observable.create(e -> {
            ...
            if (isEmpty(bookInfoBean.getCoverUrl())) {
                bookInfoBean.setCoverUrl(analyzeElement.getAllResultList(bookSourceBean.getRuleCoverUrl()).get(0));
            }
            ...
            String chapterUrl = analyzeElement.getAllResultList(bookSourceBean.getRuleChapterUrl()).get(0);
