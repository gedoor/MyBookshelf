    ...
    public void upThemeStore() {
        if (configPreferences.getBoolean("nightTheme", false)) {
            ThemeStore.editTheme(this)
                    ...
                    .backgroundColor(configPreferences.getInt("backgroundColor", getResources().getColor(R.color.backgroundNight)))
                    .apply();
        } else {
            ThemeStore.editTheme(this)
                    ...
                    .backgroundColor(configPreferences.getInt("backgroundColor", getResources().getColor(R.color.background)))
                    .apply();
        }
    }
